using Academic.Api.Common.Extensions;
using Serilog;
using SharedKernel.Observability;
using SharedKernel.Observability.Logging;

const string serviceName = "academic-api";
...
try
{
    ...
    builder.Services.AddAcademicServices(builder.Configuration);

    var app = builder.Build();

    app.UseApplicationObservability();
    await app.UseAcademicPipeline();
