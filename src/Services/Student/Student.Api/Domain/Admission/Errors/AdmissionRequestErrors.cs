...
public class AdmissionRequestErrors
{
    ...
    public static readonly Error CannotSubmitRequest = 
        new("AdmissionRequest.CannotSubmitRequest", "Admission request cannot be submitted in its current status.", ErrorType.Conflict);
    public static readonly Error AdmissionRequestIsNotComplete = 
        new("AdmissionRequest.AdmissionRequestIsNotComplete", "Admission request is not complete.", ErrorType.Conflict);
