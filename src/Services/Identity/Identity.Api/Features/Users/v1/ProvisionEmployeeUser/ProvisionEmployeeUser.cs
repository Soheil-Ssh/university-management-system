...
namespace Identity.Api.Features.Users.v1.ProvisionEmployeeUser;

public class ProvisionEmployeeUser
{
    public sealed class IntegrationEventHandler(ISender sender)
        : IIntegrationEventHandler<CreateEmployeeIdentityUserRequestedIntegrationEvent>
    {
        public async Task HandleAsync(CreateEmployeeIdentityUserRequestedIntegrationEvent integrationEvent,
